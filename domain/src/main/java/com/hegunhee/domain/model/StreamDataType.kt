...
sealed class StreamDataType() {
    ...
    data class OfflineData(val userLogin : String, val userName : String, val profileUrl : String) : StreamDataType()
    ...
    companion object {
        ...
        val TestJururuUnLiveStreamInfo = OfflineData(userLogin = "cotton__123", userName = "주르르",profileUrl = this.TestJururuProfileUrl)
